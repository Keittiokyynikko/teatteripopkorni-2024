<template>
    <div class="main mb-4" :style="{ '--background-color-2': blok.BackgroundColor2 }" v-editable="blok">
        <h1 class="h2 p-4 headline-info"
        :style="{ '--background-color': blok.BackgroundColor }">{{ blok.Headline }}</h1>
        <div class="main d-flex flex-column justify-content-start" 
